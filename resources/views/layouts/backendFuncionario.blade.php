...
<head>
    ...
    <title>BIENESTAR | SUBDIRECCION DE PERSONAL</title>
...
<body>
    <div id="page-container"
        ...
        @include('layouts.common.sidebarFuncionario')
        @include('layouts.common.headerFuncionario')
            ...
            <div class="content py-0">
                <div class="row fs-sm">
                    <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="#" target="_blank">BIENESTAR</a> &copy;
